...
public class SingleHessian3DFeature extends AbstractFeatureOp {
	...
	{
		Img<DoubleType> secondDerivatives = ops().create().img(RevampUtils.appendDimensionToInterval(
			secondDerivativeInterval, 0, 5), new DoubleType());
	...
	private void differenciate(RandomAccessible<FloatType> input,
		RandomAccessibleInterval<DoubleType> output, int... order)
	{
	...
	private void calculateEigenValues(EigenValues.Vector3D v, RealComposite<DoubleType> derivatives,
