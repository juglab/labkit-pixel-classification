...
public class Kernel1D {
	 ...
	 *
	 * @param halfKernel the upper half (starting at the center pixel) of the
	 ...
	 * @param originIndex the index of the array element which is the origin of the
	 *          kernel
	 */
	...
	/**
	 * Creates a one-dimensional asymmetric convolution kernel, where the origin of
