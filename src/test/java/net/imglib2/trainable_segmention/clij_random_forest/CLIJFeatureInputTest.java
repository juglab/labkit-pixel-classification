...
public class CLIJFeatureInputTest {
	...
	private final RandomAccessible<FloatType> original = Views.extendBorder(RandomImgs.seed(42)
		.nextImage(new FloatType(), 10, 10, 10));
	...
	public void test() {
			...
			pixelSize))
		{
			...
			RandomAccessibleInterval<FloatType> cutout = Views.translate(clij.pullRAI(result.buffer()),
